    ...
    const CHAR8 *pMsgStr)
{
    ...
    CHAR8       *pF = (CHAR8       *)strrchr(pFile, VOS_DIR_SEP);
...
tcmsrecv *tcmsrecv::instance()
{
    static tcmsrecv obj;
    return &obj;
}
tcmsrecv::tcmsrecv(QObject *parent):QObject(parent)
{

}
void tcmsrecv::recvProc()
{
    ...
    printf("tlc_openSession success\n");
    ...
    */
    ...
    printf("init no err,to receive while\n");
    /*
